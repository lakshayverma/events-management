...
<div class="panel panel-default col-md-8 col-md-offset-2">
    ...
    <form id="form" class="panel-body" method="post" action="tableForms/insert.php" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-5">
            <label class="col-form-label" for="item">Review For</label>
        ...
        <div class="form-group col-md-5">
            <label class="col-form-label" for="event">In Event</label>
        ...
        <div class="form-group col-md-4">
            ...
            <input id="title" name="title" class="form-control" type="text" value="<?php echo $object->title; ?>"/>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <textarea id="description" name="description" class="form-control" placeholder="A few words about the event"><?php echo $object->description; ?></textarea>
        </div>
        ...
        <div class="row btn-group-vertical col-md-6 col-md-offset-3">
            <input id="table_name" name="table_name" type="hidden" value="itemReview"/>
